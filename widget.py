...
depressed = pyglet.resource.image('ressources/button_up.png')
pressed = pyglet.resource.image('ressources/button_down.png')
hover = pyglet.resource.image('ressources/button_hover.png')
bar = pyglet.resource.image('ressources/bar.png')
knob = pyglet.resource.image('ressources/knob.png')
